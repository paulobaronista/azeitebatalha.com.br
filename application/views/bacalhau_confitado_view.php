                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8" style="margin-top: 30px;">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off box_interno" style="padding-top:5px;">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off">
                            <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/receitas/full_BacalhauConfitado.jpg" alt="Azeite Batalha">
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-info">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off">
                                <p class="texto">
                                    INGREDIENTES
                                    <br /><br />
                                    4 filés altos de bacalhau (gadus Morthua) com 150 gr cada<br />
                                    ...
                                    Coloque os filés de bacalhau em uma forma de vidro e reserve.<br />
                                    Corte os tomates ao meio, retire as sementes e coloque o alho picado.<br />
                                    Coloque os tomates junto ao bacalhau na forma e cubra com o Azeite Batalha Extra Virgem, levando ao forno a 180º por 1h20min.<br />
                                    <br /><br />
                                    Para o purê, processe o grão de bico com a água do seu cozimento e reserve.<br />
                                    Quando o bacalhau estiver pronto, aqueça o purê em fogo baixo e sirva com o bacalhau e os tomates, finalizando com um fio de Azeite Batalha Extra Virgem.
                                </p>
                            </div>
                        </div>
