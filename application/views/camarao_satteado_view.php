                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8" style="margin-top: 30px;">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off box_interno" style="padding-top:5px;">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off">
                            <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/receitas/full_CamarapSalteado.jpg" alt="Azeite Batalha">
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-info">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off">
                                <p class="texto">
                                    INGREDIENTES
                                    <br /><br />
                                    600 gr de camarão limpo e sem cabeça<br />
                                    70 ml de Azeite Batalha Intenso<br />
                                    6 dentes de alho picados + 1 dente inteiro<br />
                                    1 folha de louro<br />
                                    1 pimenta malagueta seca<br />
                                    100 ml de vinho branco seco fino<br />
                                    Sal a gosto<br />
                                    ...
                                    MODO DE PREPARO
                                    <br /><br />
                                    Aqueça uma frigideira antiaderente e sele os camarões no Azeite Batalha Intenso, por 30 segundos de cada lado.<br />
                                    Mantenha em fogo alto e adicione o alho, o louro e a pimenta malagueta, misturando um pouco e tomando cuidado para não queimar.<br />
                                    Vá adicionando o vinho branco aos poucos e misturando, até que ele se incorpore ao prato.<br />
                                    Tempere com sal a gosto e finalize com a salsinha.<br />
                                    Pegue o dente de alho inteiro e esfregue nas fatias de pão italiano.<br />
                                    Aqueça uma frigideira, coloque um fio de Azeite Batalha Intenso e doure as fatias de pão dos dois lados.<br />
                                    Sirva imediatamente o camarão com o pão italiano.
                                </p>
                            </div>
                        </div>
