                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8" style="margin-top: 30px;">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off box_interno" style="padding-top:5px;">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off">
                            <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/spanish-seafood.png" alt="Azeite Batalha">
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-info">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding-off">
                                <p class="texto">
                                    ...
                                    MODO DE PREPARO
                                    <br /><br />
                                    1 - Lave os frutos do mar e deixe no escorredor.
                                    <br /><br />
                                    2 - Na panela coloque o óleo, cebola, alho, açafrão e os frutos do mar e refogue por 4 minutos.
                                    <br /><br />
                                    3 - Coloque o arroz e refogue mais 3 minutos, acrescente a agua até cobrir todos os ingredientes, coloque o sal e a pimenta e deixe cozinhar.
                                    <br /><br />
                                    4 - Após cozido coloque em um refratário e decore com salsinha picadinha.
                                </p>
                            </div>
                        </div>
